...
function SkeletonCard() {
  return (
    <div className="pb-4 text-center shadow-[0_10px_30px_rgba(140, 82, 255, 0.9)] bg-[#5b6161] mx-1 sm:mx-4 my-8 rounded-lg px-1">
      <SkeletonTheme baseColor="#485050" highlightColor="#777d7d ">
